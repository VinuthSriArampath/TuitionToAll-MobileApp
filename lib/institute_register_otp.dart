  ...
  otpConfirmation(BuildContext context, WidgetRef ref) async {
    ...
    if (userOtp.length < 6) {
      ...
      if (otp == userOtp) {
        ...
        var request =
            http.Request('POST', Uri.parse('$instituteBaseUrl/register'));
        ...
        if (response.statusCode == 200) {
          ...
          ref.read(instituteProvider.notifier).state = Institute(name: "", email: "", contact: "", address: "", password: "", id: '', registeredTeachers: []);
