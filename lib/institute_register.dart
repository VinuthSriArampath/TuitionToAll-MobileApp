  ...
  register(BuildContext context, WidgetRef ref) async {
    ...
    if (validator(instituteName, instituteContact, instituteEmail, instituteAddress, institutePassword, instituteConfirmPassword)) {
      try {
        ...
        ref.read(instituteProvider.notifier).state= Institute(name: instituteName, email: instituteEmail, contact: instituteContact, address: instituteAddress, password: institutePassword, id: '', registeredTeachers: [], registeredStudents: [], courseList: []);
